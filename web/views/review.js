...
import { chip, inlineMarkup } from "./shared.js";
...
export async function view({ main, setTitle, alive }) {
  ...
  mount(main, html`
    <section class="doc-main">
      <h1>Review queue</h1>
      <p class="muted">Contributions that nobody has decided on yet. A human verification review with verdict “verified” admits a proposed problem; any human review with a non-negative verdict accepts a reference; AI reviews need two independent ones. ${queue.items.length ? "Oldest first." : ""}</p>

...
posed: null
areaIds: ["quantum-communication","quantum-algorithm"]
topicIds: ["quantum-capacity","computational-complexity-and-computability"]
keywords: []
difficulty: "unrated"
...
The precise gap is computability with no complexity bound, as formalized in Eq. (2). QMA-hardness for succinct inputs, [failure of every universal fixed-block truncation](https://qiqc-op.com/problem/op_3ea0de34a1fe6e0b/), and uncomputability of a restricted zero-error assisted capacity are all compatible with either answer to this problem.

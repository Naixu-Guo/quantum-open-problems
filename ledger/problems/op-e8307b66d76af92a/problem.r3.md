...
Historical GitHub report (2026-09-18): Naixu-Guo reported an implication from the Search HPS assumption to quantum-secure classical one-way functions. [Pull request #82](https://github.com/Naixu-Guo/quantum-open-problems/pull/82). Follow-up: [Naixu-Guo, 2026-09-22](https://github.com/Naixu-Guo/quantum-open-problems/pull/82#issuecomment-5770756615).

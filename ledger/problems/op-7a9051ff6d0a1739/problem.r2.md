...
The unresolved step is to decide whether regularization lowers the single-copy value in Eq. (4); equivalently, one must evaluate the entanglement of formation on tensor powers of this Choi state. The problems of [capacity-achieving codes for amplitude damping](https://qiqc-op.com/problem/op_fcd21a1a5021e464/) and [two-way quantum capacity of the amplitude-damping channel](https://qiqc-op.com/problem/op_e490c9462b37a548/) concern the same channel family but ask about channel capacities, whereas the present problem asks about the entanglement cost of a bipartite state associated with the channel.

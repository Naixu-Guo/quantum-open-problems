...
Their basic derivation of Eq. (5) uses a mean-photon-number ensemble. They also modify the construction to obtain exponentially small leakage outside the cutoff subspace, but with degraded second-order parameters; neither argument supplies Eq. (4) [WRG16](https://doi.org/10.1007/s11128-015-0997-x).

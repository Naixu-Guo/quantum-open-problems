---
id: 01M1HME78092QT46H4X9Z840T7
type: Statement
schemaVersion: "1.0"
createdBy: 01M1HME780JC7TB3G87MSB1YG9
createdAt: 2026-09-02T18:00:00Z
supersedes: null
problemId: 01M1HME780YBBJ7RC7MH0Q9AVJ
version: 1
digest: sha256:3ea54b4c4ef12f23e332daf3b80e36d516810d092f63b174f398079e9c7ac49e
clauses:
  - id: main
    label: New classes of extreme CPT maps with provable additivity/multiplicativity
    text: Identify new classes of extreme CPT maps $\Phi:M_{d_A}\to M_{d_B}$ for which one can prove the additivity conjecture $$S_{\min}(\Phi\otimes\Omega)=S_{\min}(\Phi)+S_{\min}(\Omega) \tag{23}$$ and/or the multiplicativity conjecture $$\nu_p(\Phi\otimes\Omega)=\nu_p(\Phi)\,\nu_p(\Omega) \tag{24}$$ for the appropriate range of $p$, when tensored with an arbitrary CPT $\Omega$.
    kind: decision
    resolutionCriteria: Find a genuinely new class of extreme CPT maps for which minimum-output-entropy additivity or output-norm multiplicativity can be proved.

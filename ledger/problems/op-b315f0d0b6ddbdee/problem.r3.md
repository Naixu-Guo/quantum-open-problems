...
createdAt: "2026-09-18T10:26:35.657Z"
role: "primary"
...
The complement of the six-Kraus Pauli channel in Section 2, Eqs. (3)–(8), of Uthirakalyani G, Halder, and Elkouss gives a feasible triple $(d_A,d_B,d_E)=(4,6,4)$. Nondegradability follows from the positive private information in their Eq. (50). Orthogonality of the six Pauli Kraus operators and unitality give full output supports for the complementary pair, so this triple meets the support-minimal convention of Eq. (1). The paper leaves smaller dimensions open in Section 5 [GHE26](https://arxiv.org/abs/2609.20133v1).

## Comment

The feasible set is nonempty: the [transpose-degradability existence problem](https://qiqc-op.com/problem/op_7e7e4a25fef5c994/) now has explicit examples. The feasible triple $(4,6,4)$ is not proved componentwise minimal; the candidate triples in Eq. (5) remain unresolved. Under complementation, the corresponding transpose-antidegradable triple is $(4,4,6)$. The new construction is a September 2026 preprint, not identified as peer-reviewed at the 18 September 2026 audit.

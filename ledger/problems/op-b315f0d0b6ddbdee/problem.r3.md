...
Historical GitHub report (2026-09-18): Naixu-Guo reported a feasible dimension triple for strict transpose degradability, with minimality left as a separate question. [Pull request #85](https://github.com/Naixu-Guo/quantum-open-problems/pull/85). Follow-up: [Naixu-Guo, 2026-09-22](https://github.com/Naixu-Guo/quantum-open-problems/pull/85#issuecomment-5770759167).

## Comment

The feasible set may be empty because existence of any strict transpose-degradable channel is unresolved in the [transpose-degradability existence problem](https://qiqc-op.com/problem/op_7e7e4a25fef5c994/). Under channel complementation, the triples for the equivalent strict transpose-antidegradable formulation are obtained by interchanging $d_B$ and $d_E$.

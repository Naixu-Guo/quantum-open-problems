...
Historical GitHub report (2026-09-18): Naixu-Guo reported a feasible dimension triple for strict transpose degradability, with minimality left as a separate question. [Pull request #85](https://github.com/Naixu-Guo/quantum-open-problems/pull/85).

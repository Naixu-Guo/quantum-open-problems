...
Historical GitHub report (2026-09-09): Naixu-Guo reported a CP-order argument for the nested max-relative-entropy amortization subcase (item C). [Issue #41](https://github.com/Naixu-Guo/quantum-open-problems/issues/41). Follow-up: [bikunli, 2026-09-11](https://github.com/Naixu-Guo/quantum-open-problems/issues/41#issuecomment-5628256055); [Naixu-Guo, 2026-09-11](https://github.com/Naixu-Guo/quantum-open-problems/issues/41#issuecomment-5628982142).

Historical GitHub report (2026-09-11): bikunli reported a CP-order argument for the nested max-relative-entropy amortization subcase (item C), with the follow-up qualifications described in pull request 50. [Pull request #50](https://github.com/Naixu-Guo/quantum-open-problems/pull/50).

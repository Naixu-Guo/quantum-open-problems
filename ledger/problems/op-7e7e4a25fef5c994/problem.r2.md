...
Historical GitHub report (2026-09-18): Naixu-Guo reported strict transpose-degradable channel constructions from two September preprints. [Pull request #84](https://github.com/Naixu-Guo/quantum-open-problems/pull/84). Follow-up: [Naixu-Guo, 2026-09-22](https://github.com/Naixu-Guo/quantum-open-problems/pull/84#issuecomment-5770758321).

Historical GitHub report (2026-09-24): Yuxuan Zhang (GitHub: yuxuanzhang1995) withdrew an earlier partial-result submission and asked that it not be treated as a current result; this link records the withdrawal only. [Issue #105](https://github.com/Naixu-Guo/quantum-open-problems/issues/105).

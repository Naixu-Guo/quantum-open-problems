...
topicIds: ["bell-nonlocality","quantum-hypothesis-testing"]
keywords: []
difficulty: "unrated"
...
The remaining gap is a global proof or counterexample to Eq. (3) for arbitrary $d$. The shared state is fixed; this differs from joint state–measurement optimization and from [maximizing the linear CGLMP violation](https://qiqc-op.com/problem/op_ccd560469b815618/).

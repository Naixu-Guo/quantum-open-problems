...
Wang and Duan characterize one-copy deterministic PPT distillation by a semidefinite program: a maximally entangled state of integer Schmidt rank $M$ can be distilled exactly from $\rho$ if and only if $M\leq W_0(P)^{-1}$, which gives the one-shot rate in Eq. (1) [WD16](https://doi.org/10.1103/PhysRevA.94.050301). The integer-output convention and support-projector characterization are stated explicitly in Lemma 21, Eq. (96), of [RFWG19](https://doi.org/10.1088/1367-2630/ab4732).
...
Historical GitHub report (2026-09-09): Naixu-Guo reported the distinction between the relaxed exact-PPT quantity and an integer-output one-shot rate (item I). [Issue #41](https://github.com/Naixu-Guo/quantum-open-problems/issues/41). Follow-up: [bikunli, 2026-09-11](https://github.com/Naixu-Guo/quantum-open-problems/issues/41#issuecomment-5628256055); [Naixu-Guo, 2026-09-11](https://github.com/Naixu-Guo/quantum-open-problems/issues/41#issuecomment-5628982142).

Historical GitHub report (2026-09-11): bikunli reported the distinction between the relaxed exact-PPT quantity and an integer-output one-shot rate (item I), with the follow-up qualifications described in pull request 50. [Pull request #50](https://github.com/Naixu-Guo/quantum-open-problems/pull/50).
...
**RFWG19** B. Regula, K. Fang, X. Wang, and M. Gu, “One-Shot Entanglement Distillation Beyond Local Operations and Classical Communication,” *New Journal of Physics* **21**, 103017 (2019). [doi:10.1088/1367-2630/ab4732](https://doi.org/10.1088/1367-2630/ab4732); [arXiv:1906.01648v2](https://arxiv.org/abs/1906.01648v2).

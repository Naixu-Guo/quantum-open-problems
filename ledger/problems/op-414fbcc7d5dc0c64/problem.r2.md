...
If every transpose-degradable channel is ordinarily degradable, then Eq. (8) resolves the problem. If a strict channel exists as asked in the [transpose-degradability existence problem](https://qiqc-op.com/problem/op_7e7e4a25fef5c994/), the exponential converse for that case remains unproved.

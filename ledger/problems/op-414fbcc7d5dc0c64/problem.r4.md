...
Beigi and Tomamichel’s Theorem 1 proves an exponential strong converse for every finite-dimensional memoryless quantum channel, including arbitrary encoders and joint decoders. Applying it to $\Phi$ with the rate gap $R-Q(\Phi)>0$ proves Eq. (5); Eq. (2) identifies the threshold with the single-letter capacity. This argument covers transpose-degradable channels whether or not they are ordinarily degradable [BT26](https://arxiv.org/abs/2609.11771v1).

Historical GitHub report (2026-09-09): bikunli reported that the cited general-channel exponential strong converse also covers the transpose-degradable class. [Pull request #38](https://github.com/Naixu-Guo/quantum-open-problems/pull/38).

## Comment

Updated on 2026-09-15. The complete resolution follows from Theorem 1 of the September 2026 version-1 preprint [BT26](https://arxiv.org/abs/2609.11771v1), also recorded in the [general quantum-capacity strong-converse problem](https://qiqc-op.com/problem/op_38f9dbb6c3f92b0c/). This preprint is not identified as peer-reviewed at this audit; the Solved status records its complete theorem with that publication caveat. The [existence of a strictly transpose-degradable channel](https://qiqc-op.com/problem/op_7e7e4a25fef5c994/) remains a separate question: the converse theorem neither constructs such a channel nor proves that none exists.

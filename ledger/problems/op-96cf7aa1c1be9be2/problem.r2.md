...
Historical GitHub report (2026-09-18): Naixu-Guo reported a mixed-state entanglement lower bound for quantum routing. [Pull request #87](https://github.com/Naixu-Guo/quantum-open-problems/pull/87). Follow-up: [Naixu-Guo, 2026-09-22](https://github.com/Naixu-Guo/quantum-open-problems/pull/87#issuecomment-5770760909).

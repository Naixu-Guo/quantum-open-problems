...
createdAt: "2026-09-18T10:27:13.640Z"
role: "primary"
...
topicIds: ["quantum-communication-complexity","position-based-quantum-cryptography"]
keywords: []
difficulty: "unrated"
...
where $d=\min\{\operatorname{rank}\rho_L,
 \operatorname{rank}\rho_R\}$ and the worst-case error is at most $0.09$ [Bog26](https://arxiv.org/abs/2608.05775v3). Equation (4) is logarithmic rather than polynomial in the cost measure of Eq. (2).

Version 3 strengthens the resource statement to the entanglement of formation of the original arbitrary mixed state: Theorem 1 gives $E_F(\rho_{LR})\geq[\log_2n-\log_2\log_2n-C]/13750$ for inner product and worst-case error at most $0.09$, for an absolute constant $C$ and sufficiently large $n$. The dimension bound in Eq. (4) remains in Appendix C. Since $E_F\leq E_{\mathrm{dim}}$, this adds an entanglement interpretation but does not reach the polynomial target [Bog26](https://arxiv.org/abs/2608.05775v3).

## Comment

Bogner explicitly leaves a polynomial lower bound on Eq. (2) open and notes that even a superlogarithmic bound for an explicit total family is unknown. The quantity $E_{\mathrm{dim}}$ is a rank-based shared-resource cost for arbitrary mixed states, not an entanglement monotone. Version 3 is an unrefereed preprint; its stronger entanglement-of-formation bound also remains logarithmic.
...
**Bog26** K. Bogner, “Robust Logarithmic Entanglement Lower Bound for $f$-Routing,” arXiv preprint, version 3, 1 September 2026. [arXiv:2608.05775v3](https://arxiv.org/abs/2608.05775v3).

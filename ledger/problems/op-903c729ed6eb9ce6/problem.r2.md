...
Historical GitHub report (2026-09-18): Naixu-Guo reported complex-Gaussian hafnian hiding and conditional sampling-to-estimation results, without claiming a hardness proof. [Pull request #79](https://github.com/Naixu-Guo/quantum-open-problems/pull/79). Follow-up: [Naixu-Guo, 2026-09-22](https://github.com/Naixu-Guo/quantum-open-problems/pull/79#issuecomment-5770754018).

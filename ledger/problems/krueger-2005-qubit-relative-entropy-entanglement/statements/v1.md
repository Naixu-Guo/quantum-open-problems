---
id: 01M1HME7806H2NX3F5WFE9W06B
type: Statement
schemaVersion: "1.0"
createdBy: 01M1HME780JC7TB3G87MSB1YG9
createdAt: 2026-09-02T18:00:00Z
supersedes: null
problemId: 01M1HME7800G4HYZX23YCBWM7H
version: 1
digest: sha256:193db0f75e63fbde831c1f49cddc1f07e941374f0b8394dfed3e42410de54cb0
clauses:
  - id: main
    label: Qubit formula for Relative Entropy of Entanglement
    text: For a bipartite state $\rho$, define $$E_R(\rho) \;=\; \inf_{\sigma \in D} S(\rho \,\|\, \sigma),$$ where $D$ is either the set of separable states or the set of states with positive partial transpose, and $S(\rho \,\|\, \sigma) = \mathrm{Tr}(\rho \log \rho) - \mathrm{Tr}(\rho \log \sigma)$ is the quantum relative entropy.
    kind: decision
    resolutionCriteria: Find a closed expression that maps an arbitrary two-qubit density matrix to its relative entropy of entanglement.

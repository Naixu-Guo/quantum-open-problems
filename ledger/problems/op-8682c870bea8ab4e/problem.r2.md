...
Van Herstraeten, Jabbour, and Cerf prove the stronger continuous-majorization relation for Wigner-nonnegative mixtures of the first three Fock states, which implies $h_W\geq1+\ln\pi$ on that family [VJC23](https://doi.org/10.22331/q-2023-05-24-1021).

Qian and Gagatsos prove the entropy bound for all Wigner-nonnegative states supported on $\operatorname{span}\{|0\rangle,|1\rangle\}$, including coherences (Section II). Section III gives a sufficient condition for a further class of mixed states; it does not cover every Wigner-nonnegative state [QG24](https://doi.org/10.1103/PhysRevA.110.012228).
...
**VJC23** Z. Van Herstraeten, M. G. Jabbour, and N. J. Cerf, “Continuous Majorization in Quantum Phase Space,” *Quantum* **7**, 1021 (2023). [doi:10.22331/q-2023-05-24-1021](https://doi.org/10.22331/q-2023-05-24-1021); [arXiv:2108.09167v2](https://arxiv.org/abs/2108.09167v2).

**QG24** Q. Qian and C. N. Gagatsos, “Wigner Non-negative States That Verify the Wigner Entropy Conjecture,” *Physical Review A* **110**, 012228 (2024). [doi:10.1103/PhysRevA.110.012228](https://doi.org/10.1103/PhysRevA.110.012228); [arXiv:2406.09248](https://arxiv.org/abs/2406.09248).

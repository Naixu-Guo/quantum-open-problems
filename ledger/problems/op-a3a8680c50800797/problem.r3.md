...
Historical GitHub report (2026-09-24): Yuxuan Zhang (GitHub: yuxuanzhang1995) withdrew an earlier partial-result submission and asked that it not be treated as a current result; this link records the withdrawal only. [Issue #100](https://github.com/Naixu-Guo/quantum-open-problems/issues/100).

## Comment

The unresolved task is to evaluate the phase minimum in Eq. (4), determine its lower convex envelope in Eq. (5), and construct optimal ensembles for arbitrary $\mathbf p$ when $d\geq3$. The [qubit Bell-diagonal entanglement-cost problem](https://qiqc-op.com/problem/op_aa21ac5ebca8b888/) instead asks for the regularized entanglement cost of qubit Bell-diagonal states.

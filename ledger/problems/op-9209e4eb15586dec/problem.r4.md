...
relatedProblemIds: ["01M26JZEN93BAESCCMMTRG84M0","01M1HME7803ZFMDQWV9SVP8FH8"]
...
The first certificate uses an explicit rank-two state supported on six Fock levels; numerical optimization over related families reaches about $8.4\times10^{-3}$ qubits per use at $(\eta,\nu)=(0.8,1)$, but that larger value is not certified. The second certificate in Eq. (7) also propagates by data processing to a two-dimensional parameter region. Its Eqs. (22)–(24) and Appendix B certify the second value; the smaller transmissivity $0.7818$ is only numerical and uncertified. These results disprove single-mode Gaussian optimality but do not determine the capacity [MCF+26](https://arxiv.org/abs/2607.27449).

Historical GitHub report (2026-09-09): bikunli reported the thermal-attenuator capacity literature context and source reconciliation. [Pull request #38](https://github.com/Naixu-Guo/quantum-open-problems/pull/38).

Historical GitHub report (2026-09-10): bikunli reported the thermal-attenuator capacity literature context and source reconciliation. [Pull request #48](https://github.com/Naixu-Guo/quantum-open-problems/pull/48).

Historical GitHub report (2026-09-10): bikunli reported the thermal-attenuator capacity literature context and source reconciliation. [Pull request #49](https://github.com/Naixu-Guo/quantum-open-problems/pull/49).

...
The unresolved step is an unconditional construction, or existence proof, for Eq. (2) in every $d$. The [Zauner-symmetric SIC problem](https://qiqc-op.com/problem/op_ff2e80b425aebb86/) imposes the additional requirement that the fiducial be Zauner symmetric.

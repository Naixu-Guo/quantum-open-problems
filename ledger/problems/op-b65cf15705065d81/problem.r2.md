...
For finite $\nu>0$ and finite $N_{\rm S}$, neither the optimal one-use input nor the necessity of regularization is known. This constrained problem is distinct from [the unconstrained capacity of a bosonic thermal attenuator](https://qiqc-op.com/problem/op_9209e4eb15586dec/).

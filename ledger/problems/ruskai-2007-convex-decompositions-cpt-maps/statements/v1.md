...
version: 1
digest: sha256:d131543633bad07b391ce1f96e557d95edc594bf21a4a8ee0f7f6cfbc068a534
clauses:
  - id: main
    label: Convex decompositions of CPT maps — a block matrix generalization of Horn's lemma (Audenaert–Ruskai)
    text: The source states four closely related formulations. Its printed Conjecture 2 uses a Choi-rank bound $d_2$, but that conflicts with Choi's generalized-extreme bound, its own later formulations, and the modern RA statement. The corrected rank bound is $d_1$.
    kind: decision
    resolutionCriteria: Prove or refute the strong decomposition conjecture for arbitrary input and output dimensions.

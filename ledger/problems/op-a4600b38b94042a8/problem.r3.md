...
createdAt: "2026-09-18T10:25:17.022Z"
role: "primary"
...
Hirche proves $D_{\rm sc}^{A}=D_{\rm sc}^{\infty}$, and hence Eq. (3), conditional on a diamond-smoothed channel AEP (Section 5.4 and Appendix A, Eqs. (152)–(155)) [Hir23](https://doi.org/10.22331/q-2023-07-25-1064). The smoothing is over CPTP maps. Gour subsequently gives qutrit channels for which that CPTP-smoothed asymptotic rate is strictly larger than the regularized channel relative entropy, so the general premise of this conditional route fails (September 2026 preprint, Theorems 11 and 15, Sections IV.3 and VI) [Gou26](https://arxiv.org/abs/2609.15004v1). This refutes the AEP premise, not Eq. (3); an unconditional proof or a superchannel counterexample is still needed.
...
This problem compares two causal strategy classes. It is distinct from [the problem on fully general superchannel-discrimination strategies](https://qiqc-op.com/problem/op_02bb8f8228649ac3/), which allows arbitrary interleavings of the physical components of different superchannel uses. The failure of CPTP smoothing must not be identified with a failure of the channel Stein lemma: the subchannel-smoothed AEP and fixed-error parallel channel Stein limit remain conjectural in general (Section V of [Gou26](https://arxiv.org/abs/2609.15004v1)). A replacement for the conditional argument must justify its own smoothing and trace-preservation requirements.
...
**Gou26** G. Gour, “Failure of the Asymptotic Equipartition Property for Quantum Channels,” arXiv preprint, version 1 (2026). [arXiv:2609.15004v1](https://arxiv.org/abs/2609.15004v1).

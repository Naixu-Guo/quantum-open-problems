...
Historical GitHub report (2026-09-18): Naixu-Guo reported that a CPTP-smoothed AEP premise of a conditional superchannel argument fails, without claiming to settle the superchannel equality. [Pull request #81](https://github.com/Naixu-Guo/quantum-open-problems/pull/81). Follow-up: [Naixu-Guo, 2026-09-22](https://github.com/Naixu-Guo/quantum-open-problems/pull/81#issuecomment-5770755889).

## Comment

This problem compares two causal strategy classes. It is distinct from [the problem on fully general superchannel-discrimination strategies](https://qiqc-op.com/problem/op_02bb8f8228649ac3/), which allows arbitrary interleavings of the physical components of different superchannel uses.

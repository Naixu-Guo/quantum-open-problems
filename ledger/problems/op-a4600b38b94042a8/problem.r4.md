...
Historical GitHub report (2026-09-18): Naixu-Guo reported that a CPTP-smoothed AEP premise of a conditional superchannel argument fails, without claiming to settle the superchannel equality. [Pull request #81](https://github.com/Naixu-Guo/quantum-open-problems/pull/81).

...
Historical GitHub report (2026-09-21): bikunli discussed LOCC entanglement cost for Bell-diagonal states, including the rank-two case and the higher-rank question. [Pull request #95](https://github.com/Naixu-Guo/quantum-open-problems/pull/95). Follow-up: [Naixu-Guo, 2026-09-22](https://github.com/Naixu-Guo/quantum-open-problems/pull/95#issuecomment-5770763712).

## Comment

Equation (4) determines $E_C$ only for $F\leq1/2$ and $F=1$; for $1/2<F<1$ it is an $E_F$ formula. The open task is to regularize $E_F$ for entangled rank-three and rank-four Bell-diagonal states. The [amplitude-damping Choi-state entanglement-cost problem](https://qiqc-op.com/problem/op_7a9051ff6d0a1739/) asks the analogous question for a different two-qubit family.

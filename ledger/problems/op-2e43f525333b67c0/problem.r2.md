...
Historical GitHub report (2026-09-18): Naixu-Guo reported a counterexample to second-level PPT-cost hierarchy collapse from the Brinster and collaborators preprint. [Pull request #77](https://github.com/Naixu-Guo/quantum-open-problems/pull/77). Follow-up: [Naixu-Guo, 2026-09-22](https://github.com/Naixu-Guo/quantum-open-problems/pull/77#issuecomment-5770752345).

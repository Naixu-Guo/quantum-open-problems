...
Historical GitHub report (2026-09-18): Naixu-Guo reported matching diamond-norm channel-tomography bounds from the cited preprints. [Pull request #80](https://github.com/Naixu-Guo/quantum-open-problems/pull/80). Follow-up: [Naixu-Guo, 2026-09-22](https://github.com/Naixu-Guo/quantum-open-problems/pull/80#issuecomment-5770754882).

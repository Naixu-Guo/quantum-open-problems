...
Historical GitHub report (2026-09-12): Naixu-Guo reported Peter’s two three-qubit counterexamples to the ordinary-Petz conditional-mutual-information bound. [Pull request #53](https://github.com/Naixu-Guo/quantum-open-problems/pull/53). Follow-up: [Naixu-Guo, 2026-09-12](https://github.com/Naixu-Guo/quantum-open-problems/pull/53#issuecomment-5643033429); [bikunli, 2026-09-12](https://github.com/Naixu-Guo/quantum-open-problems/pull/53#issuecomment-5644285156).

Historical GitHub report (2026-09-13): harleyru reported an additional flagged-state counterexample to the ordinary-Petz bound, with a separate analytic derivation and computational material. [Pull request #57](https://github.com/Naixu-Guo/quantum-open-problems/pull/57).

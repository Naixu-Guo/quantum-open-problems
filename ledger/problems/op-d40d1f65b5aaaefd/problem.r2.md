...
Pauwels, Pozas-Kerstjens, Del Santo, and Gisin show that the EJM can be localized with three ebits (Theorem 2). Their localization model forbids communication during the local measurement stage, with the outcome reconstructed afterward from local outputs. This differs from the adaptive LOCC model here: the one-ebit teleportation protocol communicates before Bob measures and therefore does not contradict that result. The three-ebit construction does not establish a three-ebit lower bound [PPDG25](https://doi.org/10.1103/PhysRevX.15.021013).

## Comment

The literature checked through 9 September 2026 leaves open whether $E_{\mathrm{LOCC}}^{\mathrm{exact}}(\mathcal M_{\mathrm{EJM}})=1$ or a finite-dimensional pure resource with strictly less than one ebit implements the measurement exactly. The rank-two case has the analytical resolution described in Progress, but the arbitrary-rank optimization remains unresolved; Section 5.3, p. 35 of Akibue et al. explicitly leaves higher-rank resources open [AMO26](https://doi.org/10.1007/s11005-026-02138-9). The cost is the entropy of the supplied pure resource, not an integer Bell-pair count, a net-consumption rate, or a cost under nonadaptive measurement localization. The status audit used public primary sources and later-work searches; it was not an exhaustive citation-index audit.
...
**PPDG25** J. Pauwels, A. Pozas-Kerstjens, F. Del Santo, and N. Gisin, “Classification of Joint Quantum Measurements Based on Entanglement Cost of Localization,” *Physical Review X* **15**, 021013 (2025). [doi:10.1103/PhysRevX.15.021013](https://doi.org/10.1103/PhysRevX.15.021013); [arXiv:2408.00831v2](https://arxiv.org/abs/2408.00831v2).

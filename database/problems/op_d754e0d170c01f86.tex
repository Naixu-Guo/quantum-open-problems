...
\begin{equation}
  ...
  D_{\max}^{\varepsilon}(\mathcal N\|\mathcal M)
    &:=\inf_{\substack{\widetilde{\mathcal N}\ {m CPTP}:\\
...
\begin{enumerate}[label={},leftmargin=4.8em,labelsep=0.5em]
  ...
  \href{https://doi.org/10.1103/PhysRevLett.123.150401}%
...
Quantum channels; One-shot quantum information; Quantum hypothesis testing;
Quantum information theory; Strong converse

...
\end{equation}
  ...
  \item Historical GitHub report (2026-09-22): Yuxuan Zhang (GitHub: yuxuanzhang1995) reported a candidate polynomial-time algorithm for labelled graph-state local-unitary equivalence. \href{https://github.com/Naixu-Guo/quantum-open-problems/issues/97}{Issue \#97}.
\end{itemize}

% Problem record op_dcea1e5e3032b8c5. This TeX file is derived from
% database/problems_json/op_dcea1e5e3032b8c5.json by scripts/sync-tex.mjs; edit the JSON record
% and rerun the script rather than editing this file.
\section{Quantum violations of bipartite Bell facets}
\label{sec:op_dcea1e5e3032b8c5}

% Problem record op_b93eb7197c926d9e. This TeX file is derived from
% database/problems_json/op_b93eb7197c926d9e.json by scripts/sync-tex.mjs; edit the JSON record
% and rerun the script rather than editing this file.
\section{Distillable entanglement of Bell-diagonal states}
\label{sec:op_b93eb7197c926d9e}
...
\begin{itemize}
  ...
  \sourcecite{ref:p3-barber-pirandola}{BP26}.

  \item Historical GitHub report (2026-09-21): bikunli clarified the LOCC scope of the Bell-diagonal distillation question. \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/95}{Pull request \#95}.
\end{itemize}
...
\begin{enumerate}[label={},leftmargin=4.8em,labelsep=0.5em]
  ...
  \item[\textup{[BP26]}]\label{ref:p3-barber-pirandola}
  M. Barber and S. Pirandola,
  ``Heuristic Lookahead Distillation Protocol Search,'' arXiv preprint (2026).
  \href{https://arxiv.org/abs/2608.13644}{arXiv:2608.13644}.
\end{enumerate}
...
Entanglement distillation; Bell-diagonal states; Local operations and classical communication

...
\begin{itemize}
  ...
  \item Historical GitHub report (2026-09-18): Naixu-Guo reported a feasible dimension triple for strict transpose degradability, with minimality left as a separate question. \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/85}{Pull request \#85}. Follow-up: \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/85#issuecomment-5770759167}{Naixu-Guo, 2026-09-22}.
\end{itemize}

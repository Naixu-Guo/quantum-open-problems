% Problem record op_2beed65d248be57a. This TeX file is derived from
% database/problems_json/op_2beed65d248be57a.json by scripts/sync-tex.mjs; edit the JSON record
% and rerun the script rather than editing this file.
\section{Positivity threshold for thermal-attenuator quantum capacity}
\label{sec:op_2beed65d248be57a}
...
This is the positivity-boundary subproblem of determining the

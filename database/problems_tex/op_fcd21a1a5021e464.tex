% Problem record op_fcd21a1a5021e464. This TeX file is derived from
% database/problems_json/op_fcd21a1a5021e464.json by scripts/sync-tex.mjs; edit the JSON record
% and rerun the script rather than editing this file.
\section{Capacity-achieving codes for amplitude damping}
\label{sec:op_fcd21a1a5021e464}
...
Amplitude-damping channels; Quantum capacity; Quantum coding theory; Quantum polar codes; Degradable channels

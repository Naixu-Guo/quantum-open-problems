...
\begin{enumerate}[label={},leftmargin=4.8em,labelsep=0.5em]
  ...
  \item[\textup{[SGGM26]}]\label{ref:ghe-shou}
  Laura Shou, Alexey V. Gorshkov, Victor Galitski, and Sarah H. Miller, ``Proof of the hiding conjecture for Gaussian boson sampling with an arbitrary number of squeezed input modes,'' arXiv preprint, version~1 (19 August 2026). \href{https://arxiv.org/abs/2608.19314v1}{arXiv:2608.19314v1}.
\end{enumerate}

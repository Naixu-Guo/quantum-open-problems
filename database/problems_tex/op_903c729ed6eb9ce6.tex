...
This elementary normalization calculation does not provide an average-case reduction at error $\varepsilon h_n$.
  ...
  \item Historical GitHub report (2026-09-18): Naixu-Guo reported complex-Gaussian hafnian hiding and conditional sampling-to-estimation results, without claiming a hardness proof. \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/79}{Pull request \#79}.
\end{itemize}

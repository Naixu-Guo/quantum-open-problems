...
Equation~\eqref{eq:7293-3} concerns the distribution produced using Eq.~\eqref{eq:7293-1} and the classical conditional mutual information in Eq.~\eqref{eq:7293-2}.

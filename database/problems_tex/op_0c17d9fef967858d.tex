...
\sourcecite{ref:0c17-belovs}{BR14}.
  ...
  \item Jiang and Peng's 2026 work on triangle cut sparsification gives advances for triangle listing and sparsification but explicitly leaves the adjacency-matrix gap between the $\Omega(n)$ lower bound and the $O(n^{5/4})$ upper bound unresolved. \sourcecite{ref:0c17-jiang-peng}{JP26}

  \item Historical GitHub report (2026-09-16): bikunli reported the triangle-listing and sparsification context while retaining the separate adjacency-matrix query gap. \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/71}{Pull request \#71}.
\end{itemize}
...
\href{https://arxiv.org/abs/2309.13268}{arXiv:2309.13268}.
  ...
  \item[\textup{[JP26]}]\label{ref:0c17-jiang-peng}
  Shan Jiang and Pan Peng, \emph{Quantum Algorithms for Triangle Cut Sparsification}, arXiv:2606.06287v2 (5 June 2026), listed as ICML 2026. \href{https://arxiv.org/abs/2606.06287}{arXiv:2606.06287}.
\end{enumerate}

...
\section{LOCC entanglement cost of entangled qubit Bell-diagonal states}
\label{sec:op_aa21ac5ebca8b888}

\paragraph{Problem.}
What is the LOCC entanglement cost of an entangled qubit Bell-diagonal state?
...
The question for entangled qubit Bell-diagonal states is derived from the
...
\begin{itemize}
  \item For comparison with the separable regime, let
  ...
  \item If at most two Bell probabilities are nonzero, write them as $q$ and
  ...
  \item On the entangled part of the isotropic line $p_X=p_Y=p_Z$, write the
...
Within the entangled isotropic family, Eq.~\eqref{eq:p7-isotropic-eof}
...
Entanglement cost; Bell-diagonal states; Local operations and classical communication

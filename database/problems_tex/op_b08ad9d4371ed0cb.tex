...
\begin{itemize}
  ...
  $n=8$ and $D=4$ this gives the $((7,4,4))_{4}$ formulation.  Their
  ...
  satisfies \eqref{eq:p40-ame-condition}.  At the start of Section 5 they
...
$((7,4,4))_{4}$ codes.  Existing no-go results exclude minimal-support

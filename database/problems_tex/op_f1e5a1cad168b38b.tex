% Problem record op_f1e5a1cad168b38b. This TeX file is derived from
% database/problems_json/op_f1e5a1cad168b38b.json by scripts/sync-tex.mjs; edit the JSON record
% and rerun the script rather than editing this file.
\section{Honest-party lockability of distillable key}
\label{sec:op_f1e5a1cad168b38b}
...
Quantum cryptography; Entanglement theory

\subsection*{Topic}

Entanglement measures; Local operations and classical communication; Resource conversion; Qubit systems

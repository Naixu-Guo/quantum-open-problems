...
\begin{itemize}
  ...
  \item Historical GitHub report (2026-09-18): Naixu-Guo reported that a CPTP-smoothed AEP premise of a conditional superchannel argument fails, without claiming to settle the superchannel equality. \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/81}{Pull request \#81}. Follow-up: \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/81#issuecomment-5770755889}{Naixu-Guo, 2026-09-22}.
\end{itemize}

% Problem record op_c9c62042b15fcb06. This TeX file is derived from
% database/problems_json/op_c9c62042b15fcb06.json by scripts/sync-tex.mjs; edit the JSON record
% and rerun the script rather than editing this file.
\section{Maximum number of mutually unbiased bases}
\label{sec:op_c9c62042b15fcb06}

\paragraph{Problem.}
Determine the exact maximum number $\mu(d)$ of pairwise mutually unbiased
...
\sourcecite{ref:p44-mcnulty-weigert}{MW26}.  This item narrows the general question to
determining an exact value in any one non-prime-power dimension.
...
\begin{enumerate}[label={},leftmargin=4.8em,labelsep=0.5em]
  ...
  1963--1969 (2013).
  \href{https://doi.org/10.1090/S0002-9939-2013-11487-5}{doi:10.1090/S0002-9939-2013-11487-5};
  ...
  \href{https://doi.org/10.1016/j.physleta.2007.04.059}{doi:10.1016/j.physleta.2007.04.059};
  ...
  \href{https://doi.org/10.22331/q-2024-04-30-1318}{doi:10.22331/q-2024-04-30-1318};
  ...
  \item[\textup{[HRZ22]}]\label{ref:p44-horodecki-et-al}
...
For the choice $d=6$, determining the exact value in
Eq.~\eqref{eq:p44-maximum-mubs} subsumes the
dimension-six milestone of constructing four bases or excluding seven: these
give only $\mu(6)\geq4$ or $\mu(6)\leq5$, respectively.  The milestone is
therefore recorded here rather than maintained separately
\sourcecite{ref:p44-horodecki-et-al}{HRZ22}.

% Problem record op_3770ad932d54692f. This TeX file is derived from
% database/problems_json/op_3770ad932d54692f.json by scripts/sync-tex.mjs; edit the JSON record
% and rerun the script rather than editing this file.
\section{Unconditional classical verification with one quantum prover}
\label{sec:op_3770ad932d54692f}
...
\begin{enumerate}[label={},leftmargin=4.8em,labelsep=0.5em]
  ...
  1524--1540 (1997).
  \href{https://doi.org/10.1137/S0097539795293639}{doi:10.1137/S0097539795293639}.

  \item[\textup{[Sha92]}]\label{ref:p39-shamir}
  A. Shamir, ``IP $=$ PSPACE,'' \emph{Journal of the ACM} \textbf{39},
  869--877 (1992).
  \href{https://doi.org/10.1145/146585.146609}{doi:10.1145/146585.146609}.
...
Quantum complexity theory; Quantum computation

\subsection*{Topic}

Interactive proof systems; Delegated quantum computation; Verification and validation

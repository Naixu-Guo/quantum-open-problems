% Problem record op_a3a8680c50800797. This TeX file is derived from
% database/problems_json/op_a3a8680c50800797.json by scripts/sync-tex.mjs; edit the JSON record
% and rerun the script rather than editing this file.
\section{Entanglement of formation of generalized Bell-diagonal states}
\label{sec:op_a3a8680c50800797}
...
\begin{itemize}
  ...
  \item Historical GitHub report (2026-09-24): Yuxuan Zhang (GitHub: yuxuanzhang1995) withdrew an earlier partial-result submission and asked that it not be treated as a current result; this link records the withdrawal only. \href{https://github.com/Naixu-Guo/quantum-open-problems/issues/100}{Issue \#100}.
\end{itemize}
...
\begin{enumerate}[label={},leftmargin=4.8em,labelsep=0.5em]
  ...
  \href{https://arxiv.org/abs/quant-ph/0602137}{arXiv:quant-ph/0602137}.

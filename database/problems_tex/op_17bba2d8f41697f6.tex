...
\sourcecite{ref:17bb-li-zur}{LZ25}.
  ...
  \item Historical GitHub report (2026-09-18): Naixu-Guo reported a welded-tree pathfinding lower bound and discussed the distinction between the cited colored distribution and the catalog's alternating-cycle distribution. \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/78}{Pull request \#78}.
\end{itemize}

...
\sourcecite{ref:17bb-li-zur}{LZ25}.
  ...
  \item In a September 2026 preprint, Miloschewsky and Podder prove an unrestricted quantum-query lower bound for a colored welded-tree distribution. Theorems~1.2 and~4.1 give success probability $O(q^6/N^{1/4})$ for $q\leq\sqrt N/100$, where $N=2^n$ and $n\geq16$ is even, hence $\Omega(2^{n/24})$ queries for constant success probability. Their three-color neighbor oracle uses cycles compatible with fixed edge colorings, conditioned on forming one cycle. The authors explicitly distinguish this distribution from the uniform alternating cycle in the present statement. Thus the theorem establishes an unrestricted lower bound in that colored model, while transfer to the precise distribution here remains unproved \sourcecite{ref:17bb-miloschewsky-podder}{MP26}.
\end{itemize}
...
\href{https://arxiv.org/abs/2311.07372}{arXiv:2311.07372}.
  ...
  \item[\textup{[MP26]}]\label{ref:17bb-miloschewsky-podder}
  David Miloschewsky and Supartha Podder, ``Hardness of Pathfinding in a Welded Tree,'' arXiv preprint, version~1 (17 September 2026). \href{https://arxiv.org/abs/2609.20651v1}{arXiv:2609.20651v1}.
\end{enumerate}

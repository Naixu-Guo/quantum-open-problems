...
\begin{itemize}
  ...
  \item Beigi and Tomamichel's Theorem~1 proves an exponential strong converse for every finite-dimensional memoryless quantum channel, including arbitrary encoders and joint decoders. Applying it to $\Phi$ with the rate gap $R-Q(\Phi)>0$ proves Eq.~\eqref{eq:p55-exponential-strong-converse}; Eq.~\eqref{eq:p55-single-letter-capacity} identifies the threshold with the single-letter capacity. This argument covers transpose-degradable channels whether or not they are ordinarily degradable \sourcecite{ref:p55-beigi-tomamichel}{BT26}.

  \item Historical GitHub report (2026-09-09): bikunli reported that the cited general-channel exponential strong converse also covers the transpose-degradable class. \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/38}{Pull request \#38}.
\end{itemize}
...
\begin{enumerate}[label={},leftmargin=4.8em,labelsep=0.5em]
  ...
  \item[\textup{[BT26]}]\label{ref:p55-beigi-tomamichel}

% Problem record op_1e7f431ed9013d1e. This TeX file is derived from
% database/problems_json/op_1e7f431ed9013d1e.json by scripts/sync-tex.mjs; edit the JSON record
% and rerun the script rather than editing this file.
\section{Quantum capacity of the Gaussian random-displacement channel}
\label{sec:op_1e7f431ed9013d1e}
...
Quantum error correction; Quantum Shannon theory

\subsection*{Topic}

Bosonic channels; Bosonic codes; Quantum capacity; Coherent information; Gaussian quantum information

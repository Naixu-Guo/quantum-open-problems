...
\sourcecite{ref:p59-review-41}{Rev26}.
  ...
  \item Historical GitHub report (2026-09-09): Naixu-Guo reported a complementary-qutrit construction for the mutually degradable-pair question (item A). \href{https://github.com/Naixu-Guo/quantum-open-problems/issues/41}{Issue \#41}. Follow-up: \href{https://github.com/Naixu-Guo/quantum-open-problems/issues/41#issuecomment-5628256055}{bikunli, 2026-09-11}; \href{https://github.com/Naixu-Guo/quantum-open-problems/issues/41#issuecomment-5628982142}{Naixu-Guo, 2026-09-11}.

  \item Historical GitHub report (2026-09-11): bikunli reported a complementary-qutrit construction for the mutually degradable-pair question (item A), with the follow-up qualifications described in pull request 50. \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/50}{Pull request \#50}.
\end{itemize}

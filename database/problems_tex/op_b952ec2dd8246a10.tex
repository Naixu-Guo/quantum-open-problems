% Problem record op_b952ec2dd8246a10. This TeX file is derived from
% database/problems_json/op_b952ec2dd8246a10.json by scripts/sync-tex.mjs; edit the JSON record
% and rerun the script rather than editing this file.
\section{Secret key from every entangled state}
\label{sec:op_b952ec2dd8246a10}
...
Secret-key distillation; Bound entanglement; Local operations and classical communication

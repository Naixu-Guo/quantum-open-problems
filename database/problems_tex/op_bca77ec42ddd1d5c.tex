% Problem record op_bca77ec42ddd1d5c. This TeX file is derived from
% database/problems_json/op_bca77ec42ddd1d5c.json by scripts/sync-tex.mjs; edit the JSON record
% and rerun the script rather than editing this file.
\section{The quantum PCP conjecture}
\label{sec:op_bca77ec42ddd1d5c}
...
Quantum complexity theory; Quantum error correction

\subsection*{Topic}

Quantum PCP conjecture; Hamiltonian complexity; Quantum LDPC codes; Quantum locally testable codes

...
establish the complete PPT condition in Eq.~\eqref{eq:p4-complete-ppt}.
  ...
  \item Historical GitHub report (2026-09-09): Naixu-Guo reported an operation-class distinction and an achievability argument for PPT-state-preserving operations (item B). \href{https://github.com/Naixu-Guo/quantum-open-problems/issues/41}{Issue \#41}. Follow-up: \href{https://github.com/Naixu-Guo/quantum-open-problems/issues/41#issuecomment-5628256055}{bikunli, 2026-09-11}; \href{https://github.com/Naixu-Guo/quantum-open-problems/issues/41#issuecomment-5628982142}{Naixu-Guo, 2026-09-11}.

  \item Historical GitHub report (2026-09-11): bikunli reported an operation-class distinction and an achievability argument for PPT-state-preserving operations (item B), with the follow-up qualifications described in pull request 50. \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/50}{Pull request \#50}.
\end{itemize}

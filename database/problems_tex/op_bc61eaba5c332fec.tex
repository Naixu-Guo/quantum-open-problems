...
Does Eq.~\eqref{eq:bc61-2} hold for every pure qubit $\psi$, with the target state fixed by Eq.~\eqref{eq:bc61-1}?
...
Here stabilizer protocols are built from stabilizer ancillas, Clifford unitaries, Pauli measurements, classical feedforward, and discarding; they are not arbitrary stabilizer-preserving channels \sourcecite{ref:bc61-zurel26}{Zurel26}\sourcecite{ref:bc61-fang26}{Fang26}.

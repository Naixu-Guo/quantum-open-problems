% Problem record op_7ceb25c3fe5c9403. This TeX file is derived from
% database/problems_json/op_7ceb25c3fe5c9403.json by scripts/sync-tex.mjs; edit the JSON record
% and rerun the script rather than editing this file.
\section{Lockability of two-way distillable entanglement}
\label{sec:op_7ceb25c3fe5c9403}
...
Entanglement distillation; Entanglement measures; Local operations and classical communication

...
bounds \sourcecite{ref:srtk-bbc19}{BBC+19}.  The constant-error approximate-rank formulation and its current quadratic-up-to-logarithms lower bound are documented by Mehraban and Tahmasbi and retained as open after the later Barnes--Wall analysis \sourcecite{ref:srtk-mt24}{MT24}\sourcecite{ref:srtk-ks25}{KS26}.
...
\begin{itemize}
  ...
  of exact and approximate stabilizer rank; the exact values are known at two, three, and four copies, while at five
  through seven copies only upper bounds are known, namely
  $\chi\bigl(|T\rangle^{\otimes 5}\bigr) \le 6$,
  $\chi\bigl(|T\rangle^{\otimes 6}\bigr) \le 6$, and
  ...
  \item Historical GitHub report (2026-09-08): Chengkai-Zhu discussed the asymptotic stabilizer-rank question and corrections distinguishing exact small-copy ranks from upper bounds. \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/18}{Pull request \#18}. Follow-up: \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/18#issuecomment-5585670052}{Naixu-Guo, 2026-09-08}.

  \item Historical GitHub report (2026-09-09): Naixu-Guo reported an inconsistency between historical small-copy rank bounds and the later four-copy result already cited in the record. \href{https://github.com/Naixu-Guo/quantum-open-problems/issues/42}{Issue \#42}.

  \item Historical GitHub report (2026-09-16): bikunli updated the stabilizer-rank literature context and the small-copy frontier. \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/71}{Pull request \#71}.
\end{itemize}
...
\begin{enumerate}[label={},leftmargin=4.8em,labelsep=0.5em]
  ...
  \item[\textup{[KS26]}]\label{ref:srtk-ks25}
  A. R. Kalra and P. Sinha, \emph{Stabilizer Ranks, Barnes--Wall Lattices and Magic Monotones}, \emph{Quantum} \textbf{10}, 2179 (2026). \href{https://doi.org/10.22331/q-2026-07-29-2179}{doi:10.22331/q-2026-07-29-2179}; \href{https://arxiv.org/abs/2503.04101}{arXiv:2503.04101}.
...
Both the exact and fixed-error approximate asymptotic questions remain unresolved. The strongest unconditional lower bound for constant approximation error is quadratic up to polylogarithmic factors, far below exponential. The exact-rank problem likewise has neither a polynomial upper bound nor a super-polynomial lower bound. These questions concern the length of stabilizer decompositions; by themselves they do not establish lower bounds against every classical simulation method.
...
the question.  The zoo's record ``\href{https://qiqc-op.com/problem/op_a64dc63d6ae49127/}{Universal purification with classically simulable operations}'' shares the boundary between stabilizer and magic

% Problem record op_76e284219621a785. This TeX file is derived from
% database/problems_json/op_76e284219621a785.json by scripts/sync-tex.mjs; edit the JSON record
% and rerun the script rather than editing this file.
\section{Convergence of the JRF iteration for mixed-state discrimination}
\label{sec:op_76e284219621a785}
...
\begin{itemize}
  ...
  \item Historical GitHub report (2026-09-16): Yuxuan Zhang (GitHub: yuxuanzhang1995) reported a candidate global-convergence proof for the uniformly initialized JRF iteration. \href{https://github.com/Naixu-Guo/quantum-open-problems/issues/74}{Issue \#74}.
\end{itemize}
...
\begin{enumerate}[label={},leftmargin=4.8em,labelsep=0.5em]
  ...
  \href{https://arxiv.org/abs/quant-ph/0201109}{arXiv:quant-ph/0201109}.

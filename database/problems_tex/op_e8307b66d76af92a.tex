...
Here $\operatorname{negl}(n)<n^{-a}$ eventually for every constant $a>0$, and the architecture $A$ in Eq.~\eqref{eq:e830-1} is hidden. In Eq.~\eqref{eq:e830-2}, the inverter must output a valid description in the same parameter space; invalid outputs fail verification.
...
\begin{itemize}
  ...
  \item Carrasco et al. prove that the Search HPS assumption implies the existence of quantum-secure classical one-way functions (Theorem 7.1). Their Definition 2.14 and Assumption 2.20 use Hamiltonian phase states and the same expected-fidelity inversion criterion as Eq.~\eqref{eq:e830-2}; the theorem includes the uniformly sampled parameter regime here. This establishes a consequence of the proposed hardness, without proving hardness or giving an inversion attack \sourcecite{ref:e830-carrasco26}{CEG+26}.
\end{itemize}
...
\begin{enumerate}[label={},leftmargin=4.8em,labelsep=0.5em]
  ...
  \item[\textup{[CEG+26]}]\label{ref:e830-carrasco26}
  J. Carrasco, J. Eisert, S. Ghosh, D. Hangleiter, N. K. H. Li, and R. Sweke, ``Instantiating Microcrypt: Obstacles and opportunities via tailored state certification,'' arXiv preprint, version 1 (2026), submitted 14 September 2026. \href{https://arxiv.org/abs/2609.15842v1}{arXiv:2609.15842v1}. See Definition 2.14, Assumption 2.20, and Theorem 7.1.
\end{enumerate}

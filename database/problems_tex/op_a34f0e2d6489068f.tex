% Problem record op_a34f0e2d6489068f. This TeX file is derived from
% database/problems_json/op_a34f0e2d6489068f.json by scripts/sync-tex.mjs; edit the JSON record
% and rerun the script rather than editing this file.
\section{Statistical strength of CGLMP measurements}
\label{sec:op_a34f0e2d6489068f}
...
Bell nonlocality; Quantum hypothesis testing

...
The displayed definitions, constraints, and target bounds are recorded in Eqs.~\eqref{eq:2534-7}, \eqref{eq:2534-8}.
  ...
  \item Historical GitHub report (2026-09-24): Yuxuan Zhang (GitHub: yuxuanzhang1995) reported a candidate formula for the joint high-dimensional port-based-teleportation crossover limit. \href{https://github.com/Naixu-Guo/quantum-open-problems/issues/109}{Issue \#109}.
\end{itemize}

...
The displayed definitions, constraints, and target bounds are recorded in Eqs.~\eqref{eq:d3e3-5}.
  ...
  \item Historical GitHub report (2026-09-18): Naixu-Guo reported matching diamond-norm channel-tomography bounds from the cited preprints. \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/80}{Pull request \#80}.
\end{itemize}

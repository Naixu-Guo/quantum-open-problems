...
relative entropy of entanglement \sourcecite{ref:rer-lami}{LBR26}.
  ...
  \item Historical GitHub report (2026-09-08): Chengkai-Zhu distinguished separable-reference relative entropy from its PPT-reference counterpart in the additivity literature. \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/20}{Pull request \#20}. Follow-up: \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/20#issuecomment-5585707428}{Naixu-Guo, 2026-09-08}; \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/20#issuecomment-5587820346}{Chengkai-Zhu, 2026-09-08}.
\end{itemize}
...
the closed formula and explicit optimizer archived in the \href{https://qiqc-op.com/problem/op_e2149f4ced34d1a8/}{two-qubit relative-entropy-of-entanglement problem}, weak additivity being known there
for states commuting with their optimizer
\sourcecite{ref:rer-miranowicz}{MI08}; the \href{https://qiqc-op.com/problem/op_aa21ac5ebca8b888/}{entanglement-cost problem for a qubit Bell-diagonal state} already uses the Bell-diagonal evaluation

...
evaluation of $E_R^\infty$ for Werner states by Audenaert et al.
...
\sourcecite{ref:rer-vollbrecht-werner}{VW01}.
  ...
  \item Audenaert, Eisert, Jan\'e, Plenio, Virmani, and De Moor computed $E_R^\infty$
in closed analytical form for Werner states of arbitrary dimension,
\sourcecite{ref:rer-audenaert}{AEM+01}, with the companion extension to
orthogonally invariant states with respect to the PPT set
\sourcecite{ref:rer-audenaert-orthogonal}{ADM+02},
so even the regularized value of the state in
Eq.~\eqref{eq:rer-antisymmetric-state} is fully known.
...
$E_R^\infty(\rho)>E_R(\rho)$ cannot occur, since subadditivity is trivial.

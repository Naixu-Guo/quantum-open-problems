...
requested certified numerical evaluation.
  ...
  \item Ahmed and Smith rule out finite-dimensional attainment on a rank-two
...
not determine the value or provide a certified approximation error.

  \item Historical GitHub report (2026-09-16): Naixu-Guo reported the finite-dimensional nonattainment result for squashed entanglement in the Ahmed--Smith preprint. \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/70}{Pull request \#70}.
\end{itemize}
...
\href{https://arxiv.org/abs/2203.03394}{arXiv:2203.03394}.
  ...
  \item[\textup{[AS26]}]\label{ref:sqbd-ahmed-smith}
  R. G. Ahmed and G. Smith, ``No cardinality bound for squashed
entanglement,'' arXiv preprint (2026).
\href{https://arxiv.org/abs/2609.14031v1}{arXiv:2609.14031v1}.
\end{enumerate}

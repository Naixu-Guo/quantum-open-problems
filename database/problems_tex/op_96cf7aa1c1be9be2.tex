...
\begin{itemize}
  ...
  \item Historical GitHub report (2026-09-18): Naixu-Guo reported a mixed-state entanglement lower bound for quantum routing. \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/87}{Pull request \#87}.
\end{itemize}

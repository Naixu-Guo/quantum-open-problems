...
\begin{itemize}
  ...
  \item Version~3 strengthens the resource statement to the entanglement of formation of the original arbitrary mixed state: Theorem~1 gives $E_F(\rho_{LR})\geq[\log_2n-\log_2\log_2n-C]/13750$ for inner product and worst-case error at most $0.09$, for an absolute constant $C$ and sufficiently large $n$. The dimension bound in Eq.~\eqref{eq:p38-inner-product-lower-bound} remains in Appendix~C. Since $E_F\leq E_{\mathrm{dim}}$, this adds an entanglement interpretation but does not reach the polynomial target \sourcecite{ref:p38-bogner}{Bog26}.
\end{itemize}
...
\begin{enumerate}[label={},leftmargin=4.8em,labelsep=0.5em]
  ...
  K. Bogner, ``Robust Logarithmic Entanglement Lower Bound for $f$-Routing,'' arXiv preprint, version~3, 1 September 2026. \href{https://arxiv.org/abs/2608.05775v3}{arXiv:2608.05775v3}.
\end{enumerate}

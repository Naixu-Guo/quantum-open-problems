...
\sourcecite{ref:p70-peter-counterexamples}{Pet26}.
  ...
  \item A structurally distinct classical-flag construction gives a third
...
\sourcecite{ref:p70-flagged-counterexample}{QOP26}.
  ...
  \item Historical GitHub report (2026-09-12): Naixu-Guo reported Peter's two three-qubit counterexamples to the ordinary-Petz conditional-mutual-information bound. \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/53}{Pull request \#53}. Follow-up: \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/53#issuecomment-5643033429}{Naixu-Guo, 2026-09-12}; \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/53#issuecomment-5644285156}{bikunli, 2026-09-12}.

  \item Historical GitHub report (2026-09-13): harleyru reported an additional flagged-state counterexample to the ordinary-Petz bound, with a separate analytic derivation and computational material. \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/57}{Pull request \#57}.
\end{itemize}
...
\href{https://github.com/Naixu-Guo/quantum-open-problems/blob/main/database/proofs/ordinary-petz.md}{Counterexample note and exact verification certificate}.
  ...
  \item[\textup{[QOP26]}]\label{ref:p70-flagged-counterexample}
  \emph{A flagged-state three-qubit counterexample to the
ordinary-Petz CMI bound}, independent QIQCOP Zoo contribution (10 September
2026), verified 13 September 2026.
\href{https://github.com/Naixu-Guo/quantum-open-problems/blob/main/database/proofs/ordinary-petz-flagged.md}{Proof and verification package}.
\end{enumerate}

\subsection*{Comment}

The ordinary-map requirement in

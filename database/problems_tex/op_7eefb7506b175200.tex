...
\begin{enumerate}[label={},leftmargin=4.8em,labelsep=0.5em]
  ...
  \item[\textup{[CL26]}]\label{ref:cqrc-cheng-liu}
  P.-C. Liu and H.-C. Cheng, ``Gallager's Random Coding Bound for Classical-Quantum Channels and Beyond,'' in \emph{2026 IEEE International Symposium on Information Theory (ISIT)} (2026). \href{https://doi.org/10.1109/ISIT62367.2026.11653968}{doi:10.1109/ISIT62367.2026.11653968}. Extended version: H.-C. Cheng and P.-C. Liu, ``Error Exponents for Quantum Packing Problems via an Operator Layer Cake Theorem,'' arXiv version 4, 4 June 2026. \href{https://arxiv.org/abs/2507.06232v4}{arXiv:2507.06232v4}.
\end{enumerate}

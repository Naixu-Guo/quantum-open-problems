% Problem record op_7a17786328198e24. This TeX file is derived from
% database/problems_json/op_7a17786328198e24.json by scripts/sync-tex.mjs; edit the JSON record
% and rerun the script rather than editing this file.
\section{Minimal-support frontier for absolutely maximally entangled states}
\label{sec:op_7a17786328198e24}

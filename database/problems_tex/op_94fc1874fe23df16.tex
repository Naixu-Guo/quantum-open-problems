...
\sourcecite{ref:rcs-bdfh}{BDFH25}.
  ...
  \item Go, Oh, and Jeong retain as Conjecture 1 the hardness of inverse-polynomial normalized additive-error estimation for ideal random-circuit probabilities, namely additive error $\varepsilon 2^{-n}$. Their noisy-sampling theorem transfers that assumption to local depolarizing noise but does not prove the underlying average-case hardness statement; their formulation also excludes generic sublogarithmic-depth parallel architectures. \sourcecite{ref:rcs-goj}{GOJ26}

  \item Historical GitHub report (2026-09-16): bikunli updated the distinction between random-circuit average-case hardness formulations and known results. \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/71}{Pull request \#71}.
\end{itemize}
...
\href{https://arxiv.org/abs/2411.04566v2}{arXiv:2411.04566v2}.
  ...
  \item[\textup{[GOJ26]}]\label{ref:rcs-goj}
  B. Go, C. Oh, and H. Jeong, \emph{Hardness and Complexity Transition of Noisy Random Circuit Sampling}, arXiv:2607.20804v1 (23 July 2026). \href{https://arxiv.org/abs/2607.20804}{arXiv:2607.20804}.
\end{enumerate}
...
Computational complexity and computability; Quantum supremacy; Random circuit sampling

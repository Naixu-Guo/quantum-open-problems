...
\begin{itemize}
  ...
  \item Historical GitHub report (2026-09-18): Naixu-Guo reported strict transpose-degradable channel constructions from two September preprints. \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/84}{Pull request \#84}. Follow-up: \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/84#issuecomment-5770758321}{Naixu-Guo, 2026-09-22}.

  \item Historical GitHub report (2026-09-24): Yuxuan Zhang (GitHub: yuxuanzhang1995) withdrew an earlier partial-result submission and asked that it not be treated as a current result; this link records the withdrawal only. \href{https://github.com/Naixu-Guo/quantum-open-problems/issues/105}{Issue \#105}.
\end{itemize}

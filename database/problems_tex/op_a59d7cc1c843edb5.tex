% Problem record op_a59d7cc1c843edb5. This TeX file is derived from
% database/problems_json/op_a59d7cc1c843edb5.json by scripts/sync-tex.mjs; edit the JSON record
% and rerun the script rather than editing this file.
\section{Exactly solvable nondegradable quantum channels}
\label{sec:op_a59d7cc1c843edb5}
...
Quantum capacity; Channel degradability

% Problem record op_c0b1045a614d2353. This TeX file is derived from
% database/problems_json/op_c0b1045a614d2353.json by scripts/sync-tex.mjs; edit the JSON record
% and rerun the script rather than editing this file.
\section{Delayed-onset additivity violation for minimum output R\'enyi entropy}
\label{sec:op_c0b1045a614d2353}

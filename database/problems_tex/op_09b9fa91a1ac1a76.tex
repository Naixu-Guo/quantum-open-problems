...
\begin{itemize}
  ...
  \item Historical GitHub report (2026-09-09): harleyru reported the Wei--Li--Pang preprint on leading-order metrological performance; the thread records later scope reconciliation and its supersession by pull request 50. \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/40}{Pull request \#40}.
\end{itemize}

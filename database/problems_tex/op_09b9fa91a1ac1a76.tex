...
\begin{itemize}
  ...
  \item Wei, Li, and Pang prove an asymptotically tight leading-order bound for finite-dimensional single-parameter channel estimation.  Their result gives the same leading QFI coefficient for general indefinite-causal-order processes and optimal parallel strategies, with the corresponding QC-QC asymptotic consequence \sourcecite{ref:p61-wei}{WLP26}.  This settles the leading-order question in the model of this record at preprint status, while leaving finite-query and subleading advantages open.
\end{itemize}
...
\begin{enumerate}[label={},leftmargin=4.8em,labelsep=0.5em]
  ...
  arXiv:2609.05355 (2026).
  \href{https://arxiv.org/abs/2609.05355}{arXiv:2609.05355}.
\end{enumerate}

\subsection*{Comment}

Mothe, Branciard, and Abbott's three-use separation remains a finite-resource advantage.  Wei, Li, and Pang's arXiv preprint gives an asymptotically tight leading-coefficient result for finite-dimensional single-parameter channel estimation and states the corresponding QC-QC consequence \sourcecite{ref:p61-wei}{WLP26}; this supports Eq.~\eqref{eq:p61-asymptotic-qcqc-ratio} under the record's model, but the result is not yet peer reviewed and does not settle subleading terms.

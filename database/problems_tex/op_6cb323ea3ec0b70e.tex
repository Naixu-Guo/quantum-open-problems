% Problem record op_6cb323ea3ec0b70e. This TeX file is derived from
% database/problems_json/op_6cb323ea3ec0b70e.json by scripts/sync-tex.mjs; edit the JSON record
% and rerun the script rather than editing this file.
\section{Trace-exponential lower bound for matrix-word averages}
\label{sec:op_6cb323ea3ec0b70e}

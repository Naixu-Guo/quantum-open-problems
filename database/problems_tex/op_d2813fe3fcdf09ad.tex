...
\begin{itemize}
  ...
  whole parameter space and record that the private information of this
  family is superadditive \sourcecite{ref:pd-poshtvan-karimipour}{PK22}; and
...
\begin{enumerate}[label={},leftmargin=4.8em,labelsep=0.5em]
  ...
  K. Li, A. Winter, X. Zou, and G.-C. Guo, ``Private capacity of quantum
  channels is not additive,'' \emph{Physical Review Letters} \textbf{103},
  120501 (2009).
  ...
  ``Superadditivity effects of quantum capacity decrease with the
  dimension for qudit depolarizing channels,'' \emph{Physical Review A}
...
same channel family; $P\ge\mathcal Q$ is the only known relation between the
two values, equality being unproven for every $p>0$.

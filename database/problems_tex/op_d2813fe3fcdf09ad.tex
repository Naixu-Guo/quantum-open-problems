...
pure-state-ensemble rate on this channel, is part of what is open.
...
\begin{itemize}
  ...
  degradable flag extensions that gave, at the time, the strongest upper
  bounds on the quantum and private capacities of the depolarizing channel
  ...
  \item Historical GitHub report (2026-09-08): Chengkai-Zhu clarified the private-capacity parameter regions and the relation to quantum capacity. \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/19}{Pull request \#19}. Follow-up: \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/19#issuecomment-5585706497}{Naixu-Guo, 2026-09-08}.
\end{itemize}
...
\href{https://qiqc-op.com/problem/op_3ea0de34a1fe6e0b/}{Universal finite truncation of quantum and private capacities}) not excluding finite stabilization for
this particular channel; and it is open whether
$P(\Lambda_p)>\mathcal Q(\Lambda_p)$ somewhere on $0<p<\tfrac{1}{3}$.  The sibling record
\href{https://qiqc-op.com/problem/op_291a943fdec5bd1d/}{Squashed entanglement of the qubit depolarizing channel} asks for the squashed entanglement
...
\href{https://qiqc-op.com/problem/op_43d4aca67bd52554/}{Quantum capacity of a qubit Pauli channel} asks for the quantum capacity of the
same channel family.  The inequality $P\ge\mathcal Q$ is the only relation
between the two values known for all $p$; both capacities vanish on the
antidegradable region $p\ge\tfrac{1}{3}$ and both equal $1$ at $p=0$, so
equality is settled there and unproven only on the nontrivial interval
$0<p<\tfrac{1}{3}$.

% Problem record op_08387c140f552732. This TeX file is derived from
% database/problems_json/op_08387c140f552732.json by scripts/sync-tex.mjs; edit the JSON record
% and rerun the script rather than editing this file.
\section{Fixed-error parallel Stein lemma for quantum channels}
\label{sec:op_08387c140f552732}
...
\begin{itemize}
  ...
  \item For finite $D_{\max}(\mathcal N\|\mathcal M)$, Gour's Theorem 14,
  ...
  inputs.  These equivalent assertions remain open in general.

  \item Historical GitHub report (2026-09-16): Naixu-Guo reported a CPTP-smoothed channel-AEP counterexample and related Stein-limit implications, distinguishing the reported identity failure from remaining limit questions. \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/68}{Pull request \#68}. Follow-up: \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/68#issuecomment-5725551512}{Naixu-Guo, 2026-09-18}.
\end{itemize}
...
\begin{enumerate}[label={},leftmargin=4.8em,labelsep=0.5em]
  ...
  \item[\textup{[Gou26]}]\label{ref:p46-gour-aep}
...
Channel discrimination; Quantum hypothesis testing; Quantum relative entropy; Strong converses

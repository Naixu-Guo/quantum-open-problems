...
The displayed definitions, constraints, and target bounds are recorded in Eqs.~\eqref{eq:3b3b-1}, \eqref{eq:3b3b-2}.
...
\begin{itemize}
  ...
  \item Aaronson explicitly raised the $O(n)$ exact-size question in January 2025. The near-linear construction above substantially improves the historical upper bounds, but the linear target remains unresolved. \sourcecite{ref:3b3b-aaronson25}{Aaronson25}

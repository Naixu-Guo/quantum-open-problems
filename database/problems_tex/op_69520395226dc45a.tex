% Problem record op_69520395226dc45a. This TeX file is derived from
% database/problems_json/op_69520395226dc45a.json by scripts/sync-tex.mjs; edit the JSON record
% and rerun the script rather than editing this file.
\section{The PPT-squared conjecture}
\label{sec:op_69520395226dc45a}
...
\begin{itemize}
  ...
  \item A 2026 qutrit theorem proves a stronger statement for cones larger
  ...
  leaves higher dimensions open \sourcecite{ref:p32-an-lee}{AL26}.

  \item Nechita and Park introduced random covariant channels, including random
  ...
  \sourcecite{ref:p32-nechita-park}{NP26}.

  \item Historical GitHub report (2026-09-08): MinboGaoTHU reported random-covariant-channel evidence and a qutrit result for the PPT-squared conjecture. \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/23}{Pull request \#23}.

  \item Historical GitHub report (2026-09-08): Naixu-Guo carried forward the PPT-squared literature update from pull request 23. \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/25}{Pull request \#25}.
\end{itemize}
...
\begin{enumerate}[label={},leftmargin=4.8em,labelsep=0.5em]
  ...
  \item[\textup{[NP26]}]\label{ref:p32-nechita-park}
  I. Nechita and S.-J. Park, ``Random Covariant Quantum Channels,'' \emph{Annales
  Henri Poincar\'e} \textbf{27}, 847--907 (2026).
  \href{https://doi.org/10.1007/s00023-025-01558-y}{doi:10.1007/s00023-025-01558-y};
  \href{https://arxiv.org/abs/2403.03667}{arXiv:2403.03667}.
\end{enumerate}

\subsection*{Comment}

The two-composition claim is settled in equal dimensions two and three,
...
Quantum separability; Quantum channel structure

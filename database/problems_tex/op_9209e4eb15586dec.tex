...
\paragraph{Problem.}
What is the unassisted quantum capacity of a single-mode thermal attenuator at every strictly positive finite environment temperature?
...
\sourcecite{ref:p49-mele-et-al}{MCF+26}. The certified low-transmissivity witness is in Eqs.~(22)--(24) and Appendix~B of the 2026 preprint.
...
\begin{itemize}
  ...
  \item Asymptotic multimode symplectic-lattice GKP codes give a rate separated from the weakened upper bound used in Eq. (58) of Noh et al. by approximately $\log_2 e\simeq1.443$ qubits per channel use, up to a floor-function correction in the rate formula. That comparison also bounds the gap to the tighter bottleneck bound in Eq.~\eqref{eq:p49-bottleneck-bound}, but is not a rigorous $\log_2 e$ ceiling. Theorem 14 uses the existence of suitable high-dimensional symplectic lattices. This is an energy-unconstrained rate bound, not an exact capacity formula \sourcecite{ref:p49-noh-albert-jiang}{NAJ19}.

  \item The July 2026 preprint gives certified lower bounds from non-Gaussian one-mode inputs:
  \begin{equation}
    \begin{aligned}
  ...
  \item Historical GitHub report (2026-09-09): bikunli reported the thermal-attenuator capacity literature context and source reconciliation. \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/38}{Pull request \#38}.

  \item Historical GitHub report (2026-09-10): bikunli reported the thermal-attenuator capacity literature context and source reconciliation. \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/48}{Pull request \#48}.

  \item Historical GitHub report (2026-09-10): bikunli reported the thermal-attenuator capacity literature context and source reconciliation. \href{https://github.com/Naixu-Guo/quantum-open-problems/pull/49}{Pull request \#49}.
\end{itemize}

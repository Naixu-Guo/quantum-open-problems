% Problem record op_3ea0de34a1fe6e0b. This TeX file is derived from
% database/problems_json/op_3ea0de34a1fe6e0b.json by scripts/sync-tex.mjs; edit the JSON record
% and rerun the script rather than editing this file.
\section{Universal finite truncation of quantum and private capacities}
\label{sec:op_3ea0de34a1fe6e0b}
...
Quantum capacity; Private capacity; Additivity and regularization

    ...
    <section class="panels" aria-label="Database overview">
      <div class="panel panel-stats">
        ...
        <form class="hero-search no-math" action="${root}problems/" method="get" role="search">
          ...
          ${SEARCH_ICON}
          <input id="home-search" name="q" type="search" placeholder="Search ${stats.total} records by title, statement, ID, field, or topic" autocomplete="off">
        ...
        <div class="metric-grid">
          ${metric(questions.total, "Distinct questions")}
          ${metric(questions.unsolved, "Unsolved", "metric-unsolved")}
          ${metric(questions.solved, "Solved", "metric-solved")}

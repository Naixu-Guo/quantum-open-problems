...
\begin{itemize}
  ...
  $p_X=p_Y=p_Z=(1-f)/3$, where $f$ is the channel-fidelity parameter.
  Concatenating a nonrandom inner code with a random outer code gives
  $\mathcal{Q}(\Lambda_{\mathbf p})>0$ for $f>0.80944$, whereas the hashing
  rate in Eq.~\eqref{eq:p1-hashing-bound} becomes positive only for
  $f>0.81071$.  Thus, for $0.80944<f<0.81071$ (around $f=0.81$), the channel
  has positive quantum capacity even though $1-H(\mathbf p)<0$
  \sourcecite{ref:p1-divincenzo}{DSS98}.
...
\begin{enumerate}[label={},leftmargin=4.8em,labelsep=0.5em]
  ...
  (2025).
  \href{https://arxiv.org/abs/2509.15106v1}{arXiv:2509.15106v1}.
\end{enumerate}
...
Pauli channels; Quantum capacity; Quantum Shannon theory; Coherent information;
Qubit systems

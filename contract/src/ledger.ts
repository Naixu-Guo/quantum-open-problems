...
export class Ledger {
  ...
  /** Desired catalog field hashes, before reconciliation preserves independent service edits. */
  readonly catalogProblemProjections = new Map<string, { bodyHash: string; authoredCatalogHash: string }>();
